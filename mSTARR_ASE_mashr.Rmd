...
```{r}
totalcount<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/ASE_totalcounts.txt")
refcount<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/ASE_refcounts.txt")
meta<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/replicateinfo.txt", header=T)
```
...
```{r}
totalcount<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/totalcount_keepsites_distfilt.txt")
refcount<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/refcount_keepsites_distfilt.txt")
meta<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/pql_meta.txt", header=T)
```

## filter for sites that are in windows with some degree of regulatory activity in model 1 for methylated condition
```{r}
mod1_meth_results_posbeta<- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/model_results/model1_methonly_results.txt") %>%
  filter(beta_meth > 0)

#bedtools intersect totalcounts_keep_distfilter with mod1_meth_results_posbeta windows

filtered_methsites<-read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/ASE_methsites_filtered.bed") %>%
...
filtered_unmethsites<-read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/ASE_unmethsites_filtered.bed") %>%
  mutate(site=paste(V1, V3, sep="_")) 
```
...
methresults <- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/model_results/ASE_meth_results.txt")
unmethresults <- read.table("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/model_results/ASE_unmeth_results.txt")
...
#coverage distribution across sites for DNA and RNA in both conditions
```{r}
Meth_totalcounts_testable$RNA <- rowSums(Meth_totalcounts_testable[, 2:6])
Meth_totalcounts_testable$DNA <- rowSums(Meth_totalcounts_testable[, 7:11])
meth_sumcounts<-Meth_totalcounts_testable[,c("site", "RNA", "DNA")]
meth_sumcounts$cond<-"Methylated"
meth_sumcounts_long<-pivot_longer(data=meth_sumcounts, col=2:3, names_to="type", values_to="counts")

Unmeth_totalcounts_testable$RNA <- rowSums(Unmeth_totalcounts_testable[, 2:7])
Unmeth_totalcounts_testable$DNA <- rowSums(Unmeth_totalcounts_testable[, 8:13])
unmeth_sumcounts<-Unmeth_totalcounts_testable[,c("site", "RNA", "DNA")]
unmeth_sumcounts$cond<-"Unmethylated"
unmeth_sumcounts_long<-pivot_longer(data=unmeth_sumcounts, col=2:3, names_to="type", values_to="counts")

meth_unmeth<-rbind(meth_sumcounts_long, unmeth_sumcounts_long)

DNA_meth_unmeth<-subset(meth_unmeth, type == "DNA")

hist(log10(DNA_meth_unmeth$counts))
mean(DNA_meth_unmeth$counts)
sd(DNA_meth_unmeth$counts)

Totalcov_per_variant_hist<-ggplot(data=DNA_meth_unmeth, aes(x=log10(counts)))+
  geom_histogram(fill="white", color="darkgrey") +
  theme_bw() +
  theme(plot.title=element_text(hjust=0.5)) +
  ylab("Number of variants") +
  xlab("log10(read count)") +
  ggtitle("Distribution of total coverage per variant");Totalcov_per_variant_hist

ggsave("/Users/rachelpetersen/Library/CloudStorage/GoogleDrive-rpetersen42@gmail.com/Other computers/My MacBook Pro (1)/Lea Lab/Human_mSTARRseq/Totalcov_per_variant.pdf", Totalcov_per_variant_hist, width=4, height=3)
```
